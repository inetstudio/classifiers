...
@php
    $title = ($item->id) ? 'Редактирование значения' : 'Добавление значения';
@endphp
...
@section('content')
    ...
    <div class="row m-sm">
        <a class="btn btn-white" href="{{ route('back.classifiers.entries.index') }}">
    ...
    <div class="wrapper wrapper-content">
        ...
        {!! Form::open(['url' => (! $item->id) ? route('back.classifiers.entries.store') : route('back.classifiers.entries.update', [$item->id]), 'id' => 'mainForm', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal']) !!}
