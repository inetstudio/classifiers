...
namespace InetStudio\Classifiers\Groups\Http\Responses\Back\Utility;
...
class SuggestionsResponse implements SuggestionsResponseContract, Responsable
{
    ...
    public function toResponse($request)
    {
        $transformer = app()->make(
            'InetStudio\Classifiers\Groups\Contracts\Transformers\Back\Utility\SuggestionTransformerContract',
            [
                'type' => $this->type,
            ]
        );
